...
public class newCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Floppy-Small-icon.png"))); // NOI18N
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Arrow-Next-icon.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int answer = JOptionPane.showConfirmDialog(null, "Are you sure?", "Reset", JOptionPane.YES_NO_OPTION);
        if (answer == 0) {
            fName.setText("");
            lName.setText("");
            address.setText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            String sql = "insert into customers(Fname, Lname, Address, Postcode, Town, PhoneNumber, Email) values(?,?,?,?,?,?,?)";
            ...
            Global.newCustomerName = fName.getText() + " " + lName.getText();
            pst.execute();
            status = true;
...
//            pst.close();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (status == true) {
            ...
            pOrder.custName.setText(Global.newCustomerName);
            pOrder.setVisible(true);
            close();
        } else {
            JOptionPane.showMessageDialog(null, "Please fill the form with customer details");
        }
