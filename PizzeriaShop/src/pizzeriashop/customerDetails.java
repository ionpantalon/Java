...
public class customerDetails extends javax.swing.JFrame {
    ...
    public void displayCustDetails(String num) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (Global.phoneN.equals(phoneNumber)) {
                    ...
                    Global.customerName = fName.getText() + " " + lName.getText();
                }
            }
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Arrow-Back-icon.png"))); // NOI18N
        ...
        jLabel1.setText("Customer's details are shown below");

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Basic-Update-icon.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Document-Delete-icon.png"))); // NOI18N
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Arrow-Next-icon.png"))); // NOI18N
...
//update table
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String value4 = postcode.getText();
            String value5 = town.getText();
            String value6 = phone.getText();
            String value7 = email.getText();
            String sql = "update customers set Fname='" + value1 + "',Lname='" + value2 + "',Address='" + value3 + "', Postcode='" + value4 + "',Town='" + value5 + "',PhoneNumber='" + value6 + "',Email='" + value7 + "' where PhoneNumber='" + value6 + "'";
...
//delete customer details
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        pizzaOrders pOrder = new pizzaOrders();
        pOrder.custName.setText(Global.customerName);
